...
def bbox_iou2(box1, box2, device):
    """
    Returns the IoU of two bounding boxes
...
def write(x_1, results, colors, classes):
    ''' write text given colors and classes
    '''
    c1 = tuple(x_1[1:3].int())
    c2 = tuple(x_1[3:5].int())
    img = results[int(x_1[0])]
    cls = int(x_1[-1])
